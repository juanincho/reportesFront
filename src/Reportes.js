...
function Reportes() {
  ...
  return (
    <div className="App bg-sky-500 flex h-full flex-row justify-center items-center">
      <div className='w-3/12 bg-gray-50 h-screen space-y-5 p-4 overflow-y-auto'>

        <h1 class="text-2xl md:text-2 xl font-bold text-center mb-5 text-sky-900">
      ...
      <div className='w-9/12 flex flex-col justify-center items-center bg-gradient-to-r from-sky-900 to-sky-700 h-screen overflow-y-scroll text-white'>
        {presionado && (
          <div className='w-full flex flex-col overflow-y-auto h-auto p-4'>
            {<>
              <h2>Tabla</h2>
              <div className='overflow-y-auto h-11/12 rounded backdrop-blur-sm'>
                <Tabla arrHeaders={headers} data={data} valores={valores} />
              </div>
              {/* <h2>Pivot table</h2>
              <div className='h-screen backdrop-blur-sm'>
                <PivotTableGratis arrHeaders={headers} data={data} valores={valores} />
              </div> */}
            </>
            }
            {/* <h2>Pivot table</h2>
